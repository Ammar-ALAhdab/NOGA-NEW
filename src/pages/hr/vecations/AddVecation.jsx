...
function AddVecation() {
    ...
    const addVecation = async () => {
        Swal.fire({
            title: "هل أنت متأكد من عملية اضافة الاجازة",
            icon: "warning",
            showCancelButton: true,
            cancelButtonText: "لا",
            confirmButtonColor: "#E76D3B",
            ...
            if (result.isConfirmed) {
                axiosPrivate
                    .post(`/employees/vecations`, vecation)
                    .then(() => {
                        Swal.fire({
    ...
    //     editVecation()
    // }
    const getVecation = async (link = `/employees/vecations`) => {
        try {
        ...
        <main className="flex flex-col items-center justify-center w-full h-full flex-grow gap-4 ">
            ...
            <section className="flex items-center justify-center flex-col gap-16 w-full bg-white rounded-[30px] py-8 px-4 my-box-shadow">
                ...
                <div className="flex items-center justify-end gap-4 w-full">
                    ...
                    <ButtonComponent variant={"create"} onClick={() => { addVecation() }} />
