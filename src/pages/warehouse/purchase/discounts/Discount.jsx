...
function Discount() {
    ...
    const [lodingDiscounts, setLodingDiscounts] = useState(true)
    ...
    const editDiscount = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axiosPrivate
                    .put(`/sales/discounts/${discountId}`, discountReq)
                    .then(() => {
                        Swal.fire({
    ...
    const deleteDiscount = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axiosPrivate
                    .delete(`/sales/discounts/${discountId}`)
                    .then(() => {
                        Swal.fire({
    ...
    const getDiscount = async (link = `/sales/discounts/${discountId}`) => {
        try {
            setLodingDiscounts(true);
                    ...
                    lodingDiscounts ?
                        ...
                        <>
                            ...
                            <div className="flex items-center justify-end gap-4 w-full">
                                ...
                                <ButtonComponent variant={"delete"} onClick={() => { deleteDiscount() }} />
                                <ButtonComponent variant={"edit"} onClick={() => { editDiscount() }} />
