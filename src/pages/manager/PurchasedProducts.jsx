...
function PurchasedProducts() {
    ...
    const handleSearchClick = () => {
        ...
        getPurchases(`sales/purchases?page=1${filter}&search=${searchQuery}&branch=${branchID}`);
    };
    ...
    const handleChangePage = (event, newPage) => {
        ...
        let filter = dateFilter + statusFilter + orderingFilter;
        getPurchases(`sales/purchases?page=${newPage}${filter}&search=${searchQuery}&branch=${branchID}`);
    };
...
console.log(purchases);
    ...
    const getPurchases = async (link = `sales/purchases?&branch=${branchID}`) => {
        try {
