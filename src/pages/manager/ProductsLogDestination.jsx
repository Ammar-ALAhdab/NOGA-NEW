...
function ProductsLogDestination() {
  ...
  const handleFilterClick = () => {
    ...
    setPage(1);
    getProductsLog(`/products/transportations?${filter}&destination=${branchID}&transportation_status_any=delivered,transporting,confirmed`);
    handleCloseFilter();
  };
  ...
  const handleChangePage = (event, value) => {
    setPage(value);
    getProductsLog(
      `/products/transportations?page=${value}${searchQuery ? `&search=${searchQuery}&destination=${branchID}&transportation_status_any=delivered,transporting,confirmed` : ""
  ...
  const handleSearchClick = () => {
    ...
    getProductsLog(`/products/transportations?search=${searchQuery}&destination=${branchID}&transportation_status_any=delivered,transporting,confirmed`);
  };
  ...
  const getProductsLog = async (link = `/products/transportations?destination=${branchID}&transportation_status_any=delivered,transporting,confirmed`) => {
    try {
      setLoading(true);
      setError(null);
  ...
  return (
    <main className="flex flex-col items-center justify-between w-full h-full flex-grow gap-4">
      <Title text={"سجل حركة المنتجات المستلمة:"} />
...
export default ProductsLogDestination;
