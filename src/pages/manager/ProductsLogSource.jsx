...
function ProductsLogSource() {
  ...
  const handleFilterClick = () => {
    ...
    setPage(1);
    getProductsLog(`/products/transportations?${filter}&source=${branchID}&transportation_status_any=packaging,confirmed`);
    handleCloseFilter();
  };
  ...
  const handleChangePage = (event, value) => {
    setPage(value);
    getProductsLog(
      `/products/transportations?page=${value}${searchQuery ? `&search=${searchQuery}&source=${branchID}&transportation_status_any=packaging,confirmed` : ""
  ...
  const handleSearchClick = () => {
    ...
    getProductsLog(`/products/transportations?search=${searchQuery}&source=${branchID}&transportation_status_any=packaging,confirmed`);
  };
  ...
  const getProductsLog = async (link = `/products/transportations?source=${branchID}&source=${branchID}&transportation_status_any=packaging,confirmed`) => {
    try {
      setLoading(true);
      setError(null);
  ...
  return (
    <main className="flex flex-col items-center justify-between w-full h-full flex-grow gap-4">
      <Title text={"سجل حركة المنتجات المرسلة:"} />
...
export default ProductsLogSource;
