...
function PositionOnMapComponent({ onChange = (value) => { }, value = "34.713016581849445,36.70711612702235", title = "branch", disabled = false }) {
...
export default PositionOnMapComponent;
